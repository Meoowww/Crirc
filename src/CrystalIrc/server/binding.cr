...
module CrystalIrc::Server::Binding
  ...
  def self.send_welcome(msg)
    ...
    msg.sender.send_raw ":0 004 #{msg.sender.from} 127.0.0.1 v001 BHIRSWacdhikorswx ABCDFKLMNOQRSTYZabcefghijklmnopqrstuvz FLYZabefghjkloq" # TODO put right stuff here
  end
